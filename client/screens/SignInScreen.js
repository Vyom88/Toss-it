...
const SignInScreen = () => {
  ...
  return (
    <View style={{flex:2, backgroundColor:'#fff',flexDirection:'column',paddingHorizontal:'3%'}} >
      ...
      <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center',backgroundColor:'#ededed',width:'100%',borderRadius:10,height:60,paddingLeft:15,marginTop:13, marginBottom: 35}} >
        ...
        <View style={styles.control_container}>
          ...
          <View style={{width:'95%'}} >
                ...
                <Text style={{fontFamily:"OpenSans-Bold",textAlign:'center',marginVertical:25,color:'#818181',fontSize:20}} >Or</Text>
